...
- [pitfalls \& tricks](#pitfalls--tricks)
    ...
    - [interface](#interface-1)
        ...
        - [naming pollution](#naming-pollution)
    - [protobuf](#protobuf)
...
Since it's duck-typing, a type auto-implement an interface by just happened to have the same function signature. If this is not by design, reading code can be very confusing, especially when it happens between a struct and its owner struct or something unrelated, e.g., which all have `OnTriggerEnter` method.
